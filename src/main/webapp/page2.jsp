...
<jsp:useBean id="Tasks" scope="session" type="java.util.List<com.tasklist.hm5.entity.Task>"/>
<div style="width: 700px">
    <c:if test="${empty Tasks}"><h2 align="center">You don't have any tasks!</h2></c:if>
    <c:if test="${!empty Tasks}">
    <h2 align="center">Your HttpSession task</h2>
